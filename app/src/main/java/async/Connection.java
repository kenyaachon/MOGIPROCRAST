...
import anki.exception.MediaSyncException;
import anki.exception.UnknownHttpResponseException;
import libanki.Collection;
import libanki.sync.FullSyncer;
import libanki.sync.HttpSyncer;
import libanki.sync.MediaSyncer;
import libanki.sync.RemoteMediaServer;
import libanki.sync.RemoteServer;
import libanki.sync.Syncer;
